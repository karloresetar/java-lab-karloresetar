...
import com.kayo.lab6.services.MeasureService;
...
public class MeasureController {
    ...
    @GetMapping("")
    public ResponseEntity<Page<Measure>> getMeasures(Pageable pageable) {
        Page<Measure> measures = measureService.getMeasures(pageable);
